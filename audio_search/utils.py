...
class WaveRNN(nn.Module) :
    ...
    def create_mask(self):
        coarse_mask = torch.cat([torch.ones(self.half_rnn_dims, self.feat_dims + self.aux_dims + 2),
                                 torch.zeros(self.half_rnn_dims, 1)], dim=1)
    ...
    def generate(self, feat, aux1=None, aux2=None, aux3=None, deterministic=False, use_half=False, verbose=False,
